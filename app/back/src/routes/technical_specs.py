...
from src.services.technical_specs import get_technical_specs_bundle, post_technical_specs_update
...
async def post_technical_specs(payload : TechnicalSpecsUpdate,db: AsyncSession = Depends(get_db)):    
    try:
